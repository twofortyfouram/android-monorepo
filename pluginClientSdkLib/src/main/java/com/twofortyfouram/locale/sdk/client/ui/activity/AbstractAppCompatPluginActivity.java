...
/**
 * <p>NOTE: This class is for compatibility with Material Design via the appcompat-v7 library.  To
 * use this
 * class, appcompat-v7 must be on the application's build path.  Typically, this would involve
 * adding
...
public abstract class AbstractAppCompatPluginActivity extends AppCompatActivity
    ...
    @NonNull
    private final PluginActivityDelegate<AbstractAppCompatPluginActivity> mPluginActivityDelegate
