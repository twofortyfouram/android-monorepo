 ...
 * easier.
 */
public final class PluginActivityImplImplTest
        extends AbstractPluginActivityImplTest<PluginActivityImpl> {
    @NonNull
    @Override
    protected Class<PluginActivityImpl> getActivityClass() {
        return PluginActivityImpl.class;
    }

    @Override
    protected void setActivityJsonAndBlurb(@Nullable final JSONObject json,
            @Nullable final String blurb) {
        final PluginActivityImpl activity = mActivity.getActivity();
        activity.mJson = json;
