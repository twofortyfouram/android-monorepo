 ...
 */
@ThreadSafe
public final class TestYouCanHazNoContract implements BaseColumns {
    ...
    public static final String TABLE_NAME = "haz_no"; //$NON-NLS-1$
    ...
    public static final String MIMETYPE_DIR = ContentResolver.CURSOR_DIR_BASE_TYPE
            + ContentProviderUtil.MIME_PROVIDER_NAME_PART + ".canhazno"; //$NON-NLS-1$
    ...
    /**
     * Content URI for {@link TestYouCanHazNoContract}.
     *
     ...
     * @return The content URI for {@link TestYouCanHazNoContract}.
     */
    @NonNull
     ...
     */
    private TestYouCanHazNoContract() {
